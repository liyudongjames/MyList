...
public class FlowLayout extends ViewGroup{
    ...
    private void inial(Context context,AttributeSet attrs)  {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.my_flow);
        float verticel = typedArray.getDimension(R.styleable.my_flow_mVerticalSpacing,30);
        float horizontal = typedArray.getDimension(R.styleable.my_flow_mHorizontalSpacing,30);
